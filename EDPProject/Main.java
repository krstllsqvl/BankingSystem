...
public class Main  {
    ...
    private static final List<CustomerAccount> customerAccounts = DatabaseUtil.loadCustomerAccounts();
...
if ("Manager".equals(loggedInUser.role)) {
 ...
 exitBtn.addActionListener(_ -> dispose());
    ...
    ManagerDashboard(BankUser user, List<BankUser> bankUsers, List<CustomerAccount> customerAccounts) {
        ...
        new Font("SquanSerif", Font.BOLD, 14), Color.WHITE));
            ...
            JLabel roleName = new JLabel(currentUser.role + ": " + currentUser.name);
                        ...
                        tellerListPanel.add(roleName);
                        tellerListPanel.add(role);
                        tellerListPanel.add(statusLabel);
                        
        
        
       
     JPanel panelForBtns = new JPanel(new GridLayout(0,1,5,5));
        panelForBtns.setBounds(0, 450, 250, 250);
        panelForBtns.setOpaque(false);
        panelForBtns.setBackground(new Color(0x1d3557));
        
       
                         ImageIcon homeicon = new ImageIcon("");
                                Image homeimage = homeicon.getImage().getScaledInstance(40, 40, Image.SCALE_SMOOTH);
                                ImageIcon homeresizedIcon = new ImageIcon(homeimage);
                                JLabel homelabel = new JLabel(homeresizedIcon);
                JButton homeBtn = new JButton("Home");
                    ...
                    homeBtn.add(homelabel);
                         ...
                         ImageIcon updateicon = new ImageIcon("");
                                Image  updateimage =  updateicon.getImage().getScaledInstance(40, 40, Image.SCALE_SMOOTH);
                                ImageIcon updateresizedIcon = new ImageIcon( updateimage);
                                JLabel  updatelabel = new JLabel( updateresizedIcon);
                JButton updateCustomerInformationBtn=new JButton("Update Customer Information");
                    updateCustomerInformationBtn.setBackground(new Color(0x1d3557));
                    updateCustomerInformationBtn.setForeground(new Color(0xFFFFFF));
                    updateCustomerInformationBtn.setOpaque(false);
                     updateCustomerInformationBtn.setFont(new Font("SquanSerif",Font.PLAIN,12));
                     updateCustomerInformationBtn.add(updatelabel);
                     
                          ImageIcon transicon = new ImageIcon("");
                                Image  transimage =  transicon.getImage().getScaledInstance(40, 40, Image.SCALE_SMOOTH);
                                ImageIcon transresizedIcon = new ImageIcon( transimage);
                                JLabel  translabel = new JLabel( transresizedIcon);
                JButton transactionsBtn=new JButton("Transactions");
                     transactionsBtn.setBackground(new Color(0x1d3557));
                     transactionsBtn.setForeground(new Color(0xFFFFFF));
                     transactionsBtn.setOpaque(false);
                      transactionsBtn.setFont(new Font("SquanSerif",Font.PLAIN,12));
                      transactionsBtn.add(translabel);
                      
                        ImageIcon logOuticon = new ImageIcon("C:/Users/Jed/Documents/NetBeansProjects/EventDrivenProgramming_Project/src/eventdrivenprogramming_project/icons8-logout-48.png");
            ...
            panelForBtns.add(updateCustomerInformationBtn);
             panelForBtns.add(transactionsBtn);
        ...
        CardLayout cardLayout = new CardLayout();
          ...
          cardPanel.setBounds(250, 0, 650, 740);


           JPanel homePanel = new JPanel(null);
          homePanel.setBackground(Color.white);

          JPanel deleteAccPanel = new JPanel(null);
          deleteAccPanel.setBackground(Color.white);


          JPanel updateCustomerPanel = new JPanel(null);
          updateCustomerPanel.setBackground(Color.white);
         updateCustomerPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(0x1d3557)),
                                "UPDATE CUSTOMER INFO", TitledBorder.CENTER, TitledBorder.CENTER,
                                new Font("SansSerif", Font.BOLD, 40), new Color(0x1d3557)));
                         

          JPanel transactionsPanel = new JPanel(null);
          transactionsPanel.setBackground(Color.white);
                  ...
                  cardPanel.add(homePanel,"Home");
                        ...
                        double totalDeposits = DatabaseUtil.getTotalDeposits();
                        double totalWithdrawals = DatabaseUtil.getTotalWithdrawals();
                        int totalCustomers = DatabaseUtil.getTotalCustomers();
                         int totalTransactions = DatabaseUtil.getTotalTransactions() ;
                        
                  

                        JPanel con1 = new JPanel(null);
                        con1.setBounds(0, 0, 650, 100);
                        con1.setBackground(Color.white);
                         con1.setBorder(BorderFactory.createLineBorder(new Color(0x1d3557), 3, false));
                         
                        
                         
                          JLabel greetingsToManager = new JLabel("Hello, Manager "+currentUser.name+". Welcome to the Manager Dash Board");
                          greetingsToManager.setBounds(120, 20, 450, 50);
                            
                            con1.add(greetingsToManager);
                         

                        JPanel con = new JPanel(new GridLayout(2, 3, 2, 2));
                        con.setBounds(0, 101, 650, 600);
...
//----------------------------- END of Update Customer Info --------------------------------------------------------------------------------------END of Update Customer Info----------------------------------------------------
                   ...
                   homeBtn.addActionListener(_ -> cardLayout.show(cardPanel, "Home"));
                   

                     updateCustomerInformationBtn.addActionListener(_ -> cardLayout.show(cardPanel, "Update"));


                     transactionsBtn.addActionListener(_ -> cardLayout.show(cardPanel, "View"));
